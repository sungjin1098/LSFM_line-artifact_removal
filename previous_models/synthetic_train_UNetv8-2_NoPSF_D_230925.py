...
from model_UNetv8 import UNet_3Plus_for_S, UNet_3Plus_for_X_train, STN, Discriminator
...
parser.add_argument("--num_D", type=int, default=2, help="number of Generator learning iterations")
...
# save path
root = f'{opt.out_dir}_SyntheticUNetv8-2_NoPSF_D{opt.num_D}_{opt.a}_{opt.b}_{opt.c}_{opt.d}_lrDS_{opt.lrDisS}_lrUX_{opt.lrUNetX}_lrUS_{opt.lrUNetS}_b{opt.batch_size}'
