...
parser.add_argument("--in_dir", type=str,
                    ...
                    help="dataset path")
parser.add_argument("--out_dir", default='./230719_05_UNetv7-2_1e-2_1e-2_0', type=str)
...
parser.add_argument("--c", type=float, default=0, help="weight for loss4 (NN, Generator loss for X)")
