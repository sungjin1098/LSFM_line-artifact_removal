...
parser.add_argument("--out_dir", type=str, default='./230821_00', help='hyperparameters are saved at the end automatically')
...
# save path
root = f'{opt.out_dir}_UNetv8-1_{opt.a}_{opt.b}_{opt.c}_{opt.d}_lrDX_{opt.lrDisX}_lrDS_{opt.lrDisS}_lrUX_{opt.lrUNetX}_lrUS_{opt.lrUNetS}'
...
for e in range(opt.epoch):
    ...
    for _, datas in enumerate(train_loader):
        ...
        dis_outputX_rotated = modelDiscriminator_for_X(torch.rot90(output.clone(), k=1, dims=[2,3]))
