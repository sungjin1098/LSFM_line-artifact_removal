...
from supervised_model_UNetv8 import UNet_3Plus_for_S, UNet_3Plus_for_X, STN, Discriminator
...
parser.add_argument("--out_dir", type=str, default='./231030_03', help='hyperparameters are saved at the end automatically')
...
# save path
root = f'{opt.out_dir}_SupervisedSyntheticUNetv8-3_NoPSF_{opt.a}_{opt.c}_lrDS_{opt.lrDisS}_lrUX_{opt.lrUNetX}_lrUS_{opt.lrUNetS}_b{opt.batch_size}'
