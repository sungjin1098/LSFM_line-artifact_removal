...
from model_RDNv4 import RDN, STN
...
parser.add_argument("--out_dir", default='./230329_v4_loss15', type=str)
...
parser.add_argument("--c", type=float, default=1e-9, help="weight for loss4 term")
