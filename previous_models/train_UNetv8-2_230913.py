...
parser.add_argument("--out_dir", type=str, default='./230913_03', help='hyperparameters are saved at the end automatically')
...
# save path
root = f'{opt.out_dir}_UNetv8-2_{opt.a}_{opt.b}_{opt.c}_{opt.d}_lrDS_{opt.lrDisS}_lrUX_{opt.lrUNetX}_lrUS_{opt.lrUNetS}_b{opt.batch_size}'
