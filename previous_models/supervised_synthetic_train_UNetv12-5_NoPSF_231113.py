...
# save path
root = f'{opt.out_dir}_SupervisedSyntheticUNetv12-5_NoPSF_{opt.a}_{opt.c}_lrDS_{opt.lrDisS}_lrUX_{opt.lrUNetX}_lrUS_{opt.lrUNetS}_b{opt.batch_size}'
...
modelUNet_for_X = UNet_3Plus_for_X_additional(in_channels=1, out_channels=1, feature_scale=4, patch=opt.patch_size)
