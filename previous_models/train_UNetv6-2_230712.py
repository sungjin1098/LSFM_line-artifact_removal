...
parser.add_argument("--in_dir", type=str,
                    ...
                    help="dataset path")
parser.add_argument("--out_dir", default='./230712_05_UNetv6-2_1e-4_1e-7_1e-2', type=str)
...
parser.add_argument("--c", type=float, default=1e-2, help="weight for loss4 (NN, deviation from 1 loss for S)")
