...
class UNet_3Plus_for_S(nn.Module):
    ...
    def forward(self, inputs):
        ...
        new_d5 = self.d5_conv(self.d5tod4(hd5))
        new_d4 = self.d5tod4_conv(self.d4tod3(new_d5))
        new_d3 = self.d4tod3_conv(self.d3tod2(new_d4))
        new_d2 = self.d3tod2_conv(self.d2tod1(new_d3))
        new_d1 = self.d2tod1_conv(new_d2)
