...
from model_UNetv15 import UNet_3Plus_for_S, UNet_3Plus_for_X, STN, Discriminator_revised
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelUNet_for_S_path', type=str, default='./Final_results_모음/231213_200_unsupervised_data0321_epoch600_v15-1/unsupervised_data0321_231213_200_UNet_for_S_600_v15-1.pth')
    parser.add_argument('--modelUNet_for_X_path', type=str, default='./Final_results_모음/231213_200_unsupervised_data0321_epoch600_v15-1/unsupervised_data0321_231213_200_UNet_for_X_600_v15-1.pth')
    parser.add_argument('--out_dir', type=str, default='./Final_results_모음/231213_200_unsupervised_data0321_epoch600_v15-1')
