...
from model_UNetv4 import UNet_3Plus, STN
...
#                     help="dataset path")
parser.add_argument("--in_dir", type=str,
                    default='./dataset/6-1_cropped.tif',
                    help="dataset path")
parser.add_argument("--out_dir", default='./230628_00_UNetv4-1_10_1_1', type=str)

parser.add_argument("--a", type=float, default=10, help="weight for loss2 (NN, TV of S'' should be large)")
parser.add_argument("--b", type=float, default=1, help="weight for loss3 (NN, S' = S''')")
parser.add_argument("--c", type=float, default=1, help="wieght ofr loss4 (NN, S = S'''')")
...
for e in range(opt.epoch):
    ...
    for idx, img in enumerate(train_loader):
        ...
        # loss1: {input} and {output * mask} should be similar. --> UNet 학습에 사용
        ...
        UNet_loss = loss1 + loss2 + loss3 + loss4
    ...
    print(f'Epoch: {e + 1} / {opt.epoch}, Loss: {total_train_loss:.3f}, '
          f'Loss1: {total_loss1:.3f}, Loss2: {total_loss2:.3f}, Loss3: {total_loss3:.3f}, Loss4: {total_loss4:.3f}')
