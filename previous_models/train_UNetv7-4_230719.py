...
parser.add_argument("--in_dir", type=str,
                    ...
                    help="dataset path")
parser.add_argument("--out_dir", default='./230719_00_UNetv7-2_1e-3_1e-2_1e-1', type=str)

parser.add_argument("--a", type=float, default=1e-3, help="weight for loss2 (NN, TV of S should be large)")
parser.add_argument("--b", type=float, default=1e-2, help="weight for loss3 (NN, Deviation from 1 loss of mask S)")
parser.add_argument("--c", type=float, default=1e-1, help="weight for loss4 (NN, Generator loss for X)")
...
for e in range(opt.epoch):
    ...
    print(f'Epoch: {e + 1} / {opt.epoch}, Loss: {total_train_loss:.3f}, Loss1: {total_loss1:.3f},'
          f' Loss2: {total_loss2:.3f}, Loss3: {total_loss3:.3f}, Loss4: {total_loss4:.3f}, Loss_for_DisX: {total_lossDisX:.3f}')
