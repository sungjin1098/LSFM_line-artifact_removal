...
parser.add_argument("--in_dir", type=str,
                    ...
                    help="dataset path")
parser.add_argument("--out_dir", default='./230517_02_01', type=str)

parser.add_argument("--a", type=float, default=0, help="weight for loss2 (NN, TV of S'' should be large)")
