...
parser.add_argument("--in_dir", type=str,
                    ...
                    help="dataset path")
parser.add_argument("--out_dir", default='./230711_00_UNetv6-1_1e-4_0', type=str)

parser.add_argument("--a", type=float, default=1e-4, help="weight for loss2 (NN, TV of S should be large)")
parser.add_argument("--b", type=float, default=0, help="weight for loss3 (NN, TV of X should be small")
