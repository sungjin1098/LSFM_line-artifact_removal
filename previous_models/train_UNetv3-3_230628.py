...
parser.add_argument("--in_dir", type=str,
                    ...
                    help="dataset path")
parser.add_argument("--out_dir", default='./230628_09_UNetv3-3_10_5', type=str)

parser.add_argument("--a", type=float, default=10, help="weight for loss2 (NN, TV of S'' should be large)")
parser.add_argument("--b", type=float, default=5, help="weight for loss3 (NN, S' = S''')")
