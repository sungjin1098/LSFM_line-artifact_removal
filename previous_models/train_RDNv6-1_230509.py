...
parser.add_argument("--out_dir", default='./230510_6-1_02_a5e-1b1', type=str)

parser.add_argument("--a", type=float, default=5e-1, help="weight for loss2 term (L1 norm should be small)")
...
for e in range(opt.epoch):
    ...
    for idx, img in enumerate(train_loader):
        ...
        loss2 = opt.a * loss2
        # loss3: the difference between two 1D-projected vectors must be large
        loss3 = -opt.b * loss3

        # To train RDN, SubNet1, SubNet2 --> loss1, loss2, loss3
        RDN_loss = loss1 + loss2 + loss3
