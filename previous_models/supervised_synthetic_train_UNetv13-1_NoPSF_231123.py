...
# save path
root = f'{opt.out_dir}_SupervisedSyntheticUNetv13-1_NoPSF_{opt.a}_{opt.c}_lrDS_{opt.lrDisS}_lrUX_{opt.lrUNetX}_lrUS_{opt.lrUNetS}_b{opt.batch_size}'
...
modelUNet_for_S.load_state_dict(torch.load('./BEST_PTH/UNet_for_S_100_v13-1_supervised.pth'))
modelUNet_for_X.load_state_dict(torch.load('./BEST_PTH/UNet_for_X_100_v13-1_supervised.pth'))
